<?php
    ...
    if ($result) {
        ...
        if($hotel_id){
            $h="SELECT * FROM hotels WHERE hotel_id = '$hotel_id' ";
            $re = mysqli_query($conn, $h);
            $ho=mysqli_fetch_assoc($re);
            if($ho){
                $hname=$ho['hotel_name'];
            }
        }
        ...
        <div class="content-container" style="background-color: powderblue;display:flex;justify-content:center;">
            <div class="profile-container">
                ...
                <div class="profile-info">
                    ...
                    <p><span class="profile-label">Hotel:</span> <?php echo $hname; ?></p>
                </div>
                <a href="editprofilemanager.php" class="profile-link">Edit Profile</a>
            </div>
        </div>
    </main>
