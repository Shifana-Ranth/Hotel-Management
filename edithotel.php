    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        elseif (!is_numeric($_POST['hotel_rating']) || $_POST['hotel_rating'] < 1 || $_POST['hotel_rating'] > 5) {
            ...
            if (mysqli_query($conn, $update_hotel)) {
                echo "<script>alert('Hotel updated successfully'); window.location.href = 'managehotel.php';</script>";
            } else {
...
<body>
    ...
    <div class="edit-hotel-container">
        ...
        <form class="edit-hotel-form" method="POST" action="edithotel.php?id=<?= $hotel_id ?>" enctype="multipart/form-data">
