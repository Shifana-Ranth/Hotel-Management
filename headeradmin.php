...
<head>
    ...
    <link rel="stylesheet" href="styleheadadmin.css">
</head>
        ...
        <div class="navbar">
            <div class="sidebar">
                ...
                <div class="sidemenu">
                    ...
                    <div class="menu">
                        <ul>
                        <li><i class="fa-solid fa-house"></i><a href="adminhome.php">Home</a></li>
                        <li><i class="fa-solid fa-user"></i><a href="myadmin.php">Profile</a></li>
                        <li><i class="fa-solid fa-hotel"></i><a href="managehotel.php">Manage Hotels</a></i></li>
                        <li><i class="fa-solid fa-money-check-dollar"></i><a href="managebooking.php">Manage Bookings</a></li>
                        <li><i class="fa-solid fa-person-walking-luggage"></i><a href="manageuser.php">Manage Users</a></li>
                        <li><i class="fa-solid fa-comment"></i><a href="managereview.php">Manage Review</a></li>
